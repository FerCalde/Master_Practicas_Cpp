...
int FileUtils::TList::ElementsCounter()
{
...
int FileUtils::TList::Push(const char* _dataNewNode) //Incluye en Final de la TList
{
...
const char* FileUtils::TList::FirstElement()
{
	if (m_headTList != nullptr)
	{
...
const char* FileUtils::TList::NextElement()
{
...
const char* FileUtils::TList::Pop()
{
	if (m_headTList != nullptr)
	{
